 ...
 * 
 * Índices ordenados - permite vários índices de ordenação referentes a campos diferentes
 */
import java.util.*;
import java.io.*;
...
// fim - ordenação Classe Aluno
 ...
 // ordena array de strings -- cria e devolve array indice de inteiros ordenado
 // o array original não se altera e só se altera o array índice 
...
// fim - ordenação strings -- devolve array indice de inteiros
class Aluno {
    int num;
    String nome;
    double nota;
